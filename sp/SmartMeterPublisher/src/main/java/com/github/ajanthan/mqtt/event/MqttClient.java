...
package com.github.ajanthan.mqtt.event;

import com.github.ajanthan.mqtt.event.generators.SMARTMeterEventGenerator;
...
public class MqttClient {
    ...
    public static void main(String[] args) throws IOException, InterruptedException {
        ...
        String publisherUrl = "tcp://localhost:1886";
        String topic = "mqtt_topic_input";
        String type = "json";


         int badgeID= Integer.parseInt(args[0]);
         int code=Integer.parseInt(args[1]);
         int model=Integer.parseInt(args[2]);
         int deviceType=Integer.parseInt(args[3]);
         String status=args[4];
         Device device=new Device(badgeID,code,model,deviceType,status);
...
//
        ...
        int count=1;
        while (true) {
            //String message=new SMARTMeterEventGenerator().getEvent();
            String message=device.toEvent();
